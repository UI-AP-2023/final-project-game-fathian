...
public class Hero3 extends Hero implements Runnable {
    public Hero3() throws URISyntaxException {
        HelloApplication helloApplication = new HelloApplication();

        this.getNumber().setId("hero3number");
        this.getNumber().setAlignment(Pos.CENTER);
        this.getNumber().setPrefHeight(31.0);
        this.getNumber().setPrefWidth(171.0);
        this.getNumber().setLayoutX(449.0);
        this.getNumber().setLayoutY(740.0);
        this.getNumber().setPickOnBounds(true);

        this.setImage(new ImageView(new Image(helloApplication.getClass().getResource("images/Warrior_01__ATTACK_000.png").toURI().toString())));
        this.getImage().setId("hero3");
        this.getImage().setFitHeight(97.0);
        this.getImage().setFitWidth(206.0);
        this.getImage().setLayoutX(449.0);
